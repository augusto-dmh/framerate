    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'slug' => 'conspiracies',
                'name' => 'Conspiracies',
                'description' => 'Got a wild idea about how The Incredibles and Monster\'s Inc. are connected?',
            ],
            [
                'slug' => 'fan-fic',
                'name' => 'Fan Fiction',
                'description' => 'Got a great idea for a sequel? Tell us all about it and get the audience involved!',
            ],
        ];
